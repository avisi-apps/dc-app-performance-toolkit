...
@jira_measure("locust_user_directory_api_query_user_directories_action")
...
def app_specific_action(locust):
    ...
    logger.locust_info(f'json: {content}, status_code {r.status_code}')  # log info for debug when verbose is true in confluence.yml file
